...
exporter = metrics_exporter.new_metrics_exporter(
    enable_standard_metrics=True, connection_string='InstrumentationKey=7f038c7f-8576-4eb0-8348-99b8f1c4f153')
view_manager.register_exporter(exporter)

# Tracing
tracer = Tracer(exporter=AzureExporter(
    connection_string='InstrumentationKey=7f038c7f-8576-4eb0-8348-99b8f1c4f153'), sampler=ProbabilitySampler(1.0),)
